...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        'file:samples/hadronized_files/run_02/run_02_had_match_mphi_500_mchi_1.root'
    )
)
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('samples/analyzed/run_02/SAVE_match_had_mphi_500_mchi_1.root') )
