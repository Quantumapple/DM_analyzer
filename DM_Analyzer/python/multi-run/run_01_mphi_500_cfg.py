...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        'file:samples/hadronized_files/run_01/run_01_had_mphi_500_mchi_1.root'
    )
)
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('samples/analyzed/run_01/SAVE_had_mphi_500_mchi_1.root') )
