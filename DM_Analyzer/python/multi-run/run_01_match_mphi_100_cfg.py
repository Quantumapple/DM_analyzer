...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        'file:samples/hadronized_files/run_01/run_01_had_match_mphi_100_mchi_1.root'
    )
)
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('samples/analyzed/run_01/SAVE_match_had_mphi_100_mchi_1.root') )
